...
public class ClassPartialController extends NewCharacterPartialController {
    ...
    private void handleChangedClass(ActionEvent event) {
        ...
        String tableRowType = selectedClass.getLeveltableRow().get(0)
                .getClass().getName();
        if (!"pathfinder.data.Classes.Objects.LevelTable.SpellLevelTableRow".equals(tableRowType)) {
        ...
        if (!"pathfinder.data.Classes.Objects.LevelTable.MonkLevelTableRow".equals(tableRowType)) {
